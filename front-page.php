...
<section class="banner bg-vector-pattern bg-center bg-cover py-[12.5rem] bg-no-repeat" style="background-image: url('https://twomilesfaq.net/wp-content/uploads/2022/10/tmBanner.webp');">
        <div class="container">
            ...
            <div class="overview__wrapper">
                <div class="overview__content lg:flex lg:flex-row-reverse lg:gap-[5rem]">
                    <div class="view lg:mt-[10rem]">
                        <h2 class=" text-[47.55px] font-bold text-[#1f285b]">日米租税条約改正の概要</h2>
                        <p class=" mb-7 text-[#737373] lg:w-[65%]">２０１９年８月３０日に日米租税条約を改正する議定書に係る批准書が交換され、発効しました。 改正点の概要をお知らせします。</p>
                ...
                <?php if ($newQuery->have_posts()) : while($newQuery->have_posts()) : $newQuery->the_post(); ?>
                    ...
                    <?php echo get_the_post_thumbnail()?>
                        <div class="pcontent p-[1rem]">
                            ...
                            <a href="https://resoundstructuredcapital.com/wp-content/uploads/2021/06/The-Underserved-Christian-CEO-CEF-c-Chris-Conant-2021.pdf" class="text-dark"><?php echo get_field('read_more')?></a>
                        </div>   
                    </div>
                    <?php
                endwhile;
            ...
            <?php if ($newQuery->have_posts()) : while($newQuery->have_posts()) : $newQuery->the_post(); ?>
                    ...
                    <?php echo get_the_post_thumbnail()?>
                        <div class="ccontent p-[1rem]">
                            <h3 class="text-tmblue text-[1.3rem] mb-[1rem] font-bold pt-[1rem] lg:text-[1.5rem] "><?php the_title()?></h3>
                            <p class="text-gray-500 mb-7 lg:text-[1rem]"><?php the_content()?></p>
                            <a href="" class="font-bold text-dark">続きを読む ></a>
                        </div>   
                    </div>
                    <?php
            endwhile;
